...
class ParticleSystem(internal var m_world: World) {
    ...
    fun computeDepthForGroup(group: ParticleGroup) {
        ...
        for (i in group.m_firstIndex until group.m_lastIndex) {
            ...
            m_depthBuffer!![i] = if (w < 0.8f) 0f else java.lang.Float.MAX_VALUE
        }
        ...
        for (i in group.m_firstIndex until group.m_lastIndex) {
            ...
            if (p < java.lang.Float.MAX_VALUE) {
    ...
    fun addContact(a: Int, b: Int) {
        ...
        if (d2 < m_squaredDiameter) {
            ...
            val invD = if (d2 != 0f) MathUtils.sqrt(1 / d2) else java.lang.Float.MAX_VALUE
    ...
    fun updateBodyContacts() {
        val aabb = temp
        aabb.lowerBound.x = java.lang.Float.MAX_VALUE
        aabb.lowerBound.y = java.lang.Float.MAX_VALUE
        aabb.upperBound.x = -java.lang.Float.MAX_VALUE
        aabb.upperBound.y = -java.lang.Float.MAX_VALUE
    ...
    fun solveCollision(step: TimeStep) {
        ...
        lowerBound.x = java.lang.Float.MAX_VALUE
        lowerBound.y = java.lang.Float.MAX_VALUE
        upperBound.x = -java.lang.Float.MAX_VALUE
        upperBound.y = -java.lang.Float.MAX_VALUE
        for (i in 0 until particleCount) {
    ...
    fun solve(step: TimeStep) {
        ...
        for (i in 0 until particleCount) {
            ...
            if (v2 > criticalVelocytySquared) {
                val a = if (v2 == 0f) java.lang.Float.MAX_VALUE else MathUtils.sqrt(criticalVelocytySquared / v2)
                v.x *= a
                v.y *= a
            }
        }
    ...
    internal fun solveElastic(step: TimeStep) {
        ...
        for (k in 0 until m_triadCount) {
            ...
            if (triad.flags and ParticleType.b2_elasticParticle != 0) {
                ...
                val r2 = rs * rs + rc * rc
                val invR = if (r2 == 0f) java.lang.Float.MAX_VALUE else MathUtils.sqrt(1f / r2)
                rs *= invR
                rc *= invR
    ...
    internal fun solveSpring(step: TimeStep) {
        ...
        for (k in 0 until m_pairCount) {
            ...
            if (pair.flags and ParticleType.b2_springParticle != 0) {
                ...
                if (r1 == 0f) r1 = java.lang.Float.MAX_VALUE
    ...
    fun raycast(callback: ParticleRaycastCallback, point1: Vec2, point2: Vec2) {
        ...
        var v2 = vx * vx + vy * vy
        if (v2 == 0f) v2 = java.lang.Float.MAX_VALUE
        for (proxy in firstProxy until lastProxy) {
            val i = m_proxyBuffer[proxy].index
